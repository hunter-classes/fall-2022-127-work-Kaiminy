...
#I'm sorry but I couldn't figure out the loop and now the code is a really big block and repetitive. Most of my attempts are in file try22.py under idk.py
for i in new_text:
